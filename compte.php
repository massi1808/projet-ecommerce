...
<html lang="en">
  ...
  <body>
    ...
    <div class="formulair">
    <form  class="form1" action=""method="post"> <h1 align="center">connetez-vous!</h1>
    <div class="nom1"><input type="email"name="email"placeholder="mail"></div>

    <div class="nom1"><input type="password" name="password" placeholder="mot de passe"></div>
    <br>
    
    <button class="envoyer" type="submit">connexion</button>
