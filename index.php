...
<html lang="en">
  ...
  <body>
    ...
    <div class="imageheader1">
      <img src="images/burgess-milner-OYYE4g-I5ZQ-unsplash 1.png" alt="">
    </div>
     <!-- <a href="homme.femme.html"><div class="milieu" align="center"><em>profitez de 30% de remise sur toute votre premier achat sur notre site!</em></div></a> -->
    <div class="imageheader2">
      <img src="images/clark-street-mercantile-qnKhZJPKFD8-unsplash 1.png" alt="">
    </div>
    <div class="imageheader3">
      <div class="img1">
      ...
      <div class="img3">
        <img src="images/felix-mittermeier-nAjil1z3eLk-unsplash 1" alt="">
      </div> 
    </div>
    ...
    <footer class="footer">
      ...
      <div class="bottom">
        <p class="fin">Copyright © 2022-2023 Massinissa tous les droit reserves .</p>
      </div>
    </footer>
